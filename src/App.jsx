    ...
    <div className="app-container min-h-screen bg-gray-50">
      {!currentUser ? (
        ...
        <>
          ...
          {/* Tremmer Suite Floating Button */}
          {step !== 'login' && step !== 'admin' && (
            <button
              type="button"
              className="fixed bottom-6 right-6 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg shadow-lg transition-all duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
